...
function handleAdd() {
  const newItems = [...props.modelValue, { key: '', value: '', enabled: true }]
  emit('update:modelValue', newItems)
}
</script>
...
<template>
  <div class="space-y-0">
    ...
    <div class="border border-border-default rounded">
      <!-- Header Row -->
      <div class="grid grid-cols-[28px_1fr_1fr_40px] divide-x divide-border-default bg-surface-base rounded-t">
